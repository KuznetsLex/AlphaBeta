...
//проверка написания
        ...
        btnClassify.setOnClickListener {
            ...
            counta += 1
            if (txtOutput.text != ""){
                if ("H" in lettera.substringBefore(',')||"h" in lettera.substringBefore(',')) {
                ...
                val randomIntent = Intent(this, H::class.java)
        ...
        propis.setImageResource(R.drawable.bukva_h)
    }
        ...
        when (requestCode) {
            REQ_CODE -> {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if ((a == "H") or (a == "h") or (a == "аш") or (a == "эйч") or (a == "эйтч") or (a == "эйдж")) {
                        var resID = getResources().getIdentifier("good", "raw", getPackageName())
                        val mediaPlayer = MediaPlayer.create(this, resID)
                        mediaPlayer.start()
                    } else{
                        var resID = getResources().getIdentifier("h_again", "raw", getPackageName())
                        val mediaPlayer = MediaPlayer.create(this, resID)
                        mediaPlayer.start()
                    }
                }

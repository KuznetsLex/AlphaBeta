...
//проверка написания
        ...
        btnClassify.setOnClickListener {
            ...
            counta += 1
            if (txtOutput.text != ""){
                if ("P" in lettera.substringBefore(',')||"p" in lettera.substringBefore(',')) {
                ...
                val randomIntent = Intent(this, P::class.java)
        ...
        propis.setImageResource(R.drawable.bukva_p)
    }

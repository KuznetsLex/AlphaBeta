...
//проверка написания
        ...
        btnClassify.setOnClickListener {
            ...
            counta += 1
            if (txtOutput.text != ""){
                if ("w" in lettera.substringBefore(',')||"W" in lettera.substringBefore(',')) {
                ...
                val randomIntent = Intent(this, W::class.java)
        ...
        propis.setImageResource(R.drawable.bukva_w)
    }
            ...
            REQ_CODE -> {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if ((a == "W") or (a == "w") or (a == "дабл ю") or (a == "W")) {
                        ...
                        var resID = getResources().getIdentifier("w_again", "raw", getPackageName())
                        val mediaPlayer = MediaPlayer.create(this, resID)
                        mediaPlayer.start()
                    }
                }

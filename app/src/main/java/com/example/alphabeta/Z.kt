...
//проверка написания
        ...
        btnClassify.setOnClickListener {
            ...
            counta += 1
            if (txtOutput.text != ""){
                if ("z" in lettera.substringBefore(',')||"2" in lettera.substringBefore(',')||"Z" in lettera.substringBefore(',')) {
                ...
                val randomIntent = Intent(this, Z::class.java)
        ...
        propis.setImageResource(R.drawable.bukva_z)
    }
            ...
            REQ_CODE -> {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if ((a == "Z") or (a == "z") or (a == "зед") or (a == "зет") or (a == "зэт") or (a == "зэд")) {
                        ...
                        var resID = getResources().getIdentifier("z_again", "raw", getPackageName())
                        val mediaPlayer = MediaPlayer.create(this, resID)
                        mediaPlayer.start()
                    }
                }
